...
label = "batu"
subject = "han"
folderName = os.getcwd()+"\\Dataset\\"
filename2 = folderName+label + "-" + subject + "-" + startTime + ".csv"
print startTime
def angle(v1, v2):
    angle =np.arccos(np.dot(v1, v2) / (np.linalg.norm(v1) * np.linalg.norm(v2)))
        #np.arccos(np.dot(v1, v2)/np.dot(np.linalg.norm(v1),np.linalg.norm(v2)))#np.arccos(np.dot(v1, v2) / (np.linalg.norm(v1) * np.linalg.norm(v2)))
...
class SampleListener(Leap.Listener):
    ...
    def on_frame(self, controller):
        ...
        if True:
            ...
            left_hand_extended=[0,0,0,0,0]
            left_hand_pinch=0
            left_hand_strength=0
            # Get hands
        ...
        for hand in frame.hands:
            ...
            if handType == "Left hand":
                ...
                #left_hand_extended = frame.fingers.extended().fingers
                #left_hand_extended=[left_hand_extendedx[0],left_hand_extendedx[0],left_hand_extendedx[1],left_hand_extendedx[2],left_hand_extendedx[3],left_hand_extendedx[4]]
                left_hand_pinch = hand.pinch_strength
                left_hand_strength = hand.grab_strength
            ...
            if handType == "Right hand":
                ...
                right_palm_normal=[hand.palm_normal[0],hand.palm_normal[1],hand.palm_normal[2]]
                    ...
                    if self.finger_names[finger.type] == "Thumb":
                        ...
                        for b in range(0, 4):
                            if b == 0:
                                ...
                                # direction
                                right_thumb_metacarpal_direction = [bone.direction[0], bone.direction[1], bone.direction[2]]
                            ...
                            if b == 1:
                                ...
                                # direction
                                right_thumb_proximal_direction = [bone.direction[0], bone.direction[1], bone.direction[2]]
                            ...
                            if b == 2:
                                ...
                                # direction
                                right_thumb_intermediate_direction = [bone.direction[0], bone.direction[1], bone.direction[2]]
                            ...
                            if b == 3:
                                ...
                                # direction
                                right_thumb_distal_direction = [bone.direction[0], bone.direction[1], bone.direction[2]]
                        ...
                        #global thumb_angles
                        thumb_angles=[angle(right_palm_normal, right_thumb_metacarpal_direction),
                         angle(right_thumb_metacarpal_direction, right_thumb_proximal_direction),
                         angle(right_thumb_proximal_direction, right_thumb_intermediate_direction),
                         angle(right_thumb_intermediate_direction,
                               right_thumb_distal_direction)]  # [left_hand_pinch , left_hand_strength]
                    ...
                    if self.finger_names[finger.type] == "Index":
                        ...
                        for b in range(0, 4):
                            if b == 0:
                                ...
                                # direction
                                right_index_metacarpal_direction = [bone.direction[0],bone.direction[1],bone.direction[2]]
                            ...
                            if b == 1:
                                ...
                                # direction
                                right_index_proximal_direction = [bone.direction[0],bone.direction[1],bone.direction[2]]
                            ...
                            if b == 2:
                                ...
                                # direction
                                right_index_intermediate_direction = [bone.direction[0],bone.direction[1],bone.direction[2]]
                            ...
                            if b == 3:
                                ...
                                # direction
                                right_index_distal_direction = [bone.direction[0],bone.direction[1],bone.direction[2]]
                        ...
                        index_angles = [angle(right_palm_normal, right_index_metacarpal_direction),
                                        angle(right_index_metacarpal_direction, right_index_proximal_direction),
                                        angle(right_index_proximal_direction, right_index_intermediate_direction),
                                        angle(right_index_intermediate_direction,
                                              right_index_distal_direction)]
                        print(index_angles)
                    if self.finger_names[finger.type] == "Middle":
                        # print "Right Middle!"
                        ...
                        for b in range(0, 4):
                            if b == 0:
                                ...
                                # direction
                                right_middle_metacarpal_direction = [bone.direction[0], bone.direction[1], bone.direction[2]]
                            ...
                            if b == 1:
                                ...
                                # direction
                                right_middle_proximal_direction = [bone.direction[0], bone.direction[1],
                                                                     bone.direction[2]]
                            ...
                            if b == 2:
                                ...
                                # direction
                                right_middle_intermediate_direction = [bone.direction[0], bone.direction[1],
                                                                   bone.direction[2]]
                            ...
                            if b == 3:
                                ...
                                # direction
                                right_middle_distal_direction = [bone.direction[0], bone.direction[1],
                                                                   bone.direction[2]]
                        ...
                        middle_angles = [angle(right_palm_normal, right_middle_metacarpal_direction),
                                        angle(right_middle_metacarpal_direction, right_middle_proximal_direction),
                                        angle(right_middle_proximal_direction, right_middle_intermediate_direction),
                                        angle(right_middle_intermediate_direction,
                                              right_middle_distal_direction)]
                        #print middle_angles
                    if self.finger_names[finger.type] == "Ring":
                        # print "Right Ring!"
        ...
        if not (frame.hands.is_empty and frame.gestures().is_empty):
            ...
            recorded_variables = [left_palm_position_x, left_palm_position_y, left_palm_position_z, left_palm_normal_x,
                                  left_palm_normal_y, left_palm_normal_z, left_hand_direction_x, left_hand_direction_y,
                                  left_hand_direction_z, left_palm_velocity_x, left_palm_velocity_y,
                                  left_palm_velocity_z, left_hand_pitch, left_hand_roll, left_hand_yaw,
                                  left_arm_direction_x, left_arm_direction_y, left_arm_direction_z,
                                  left_wrist_position_x, left_wrist_position_y, left_wrist_position_z,
                                  left_elbow_position_x, left_elbow_position_y, left_elbow_position_z,
                                  left_thumb_length, left_thumb_width, left_thumb_metacarpal_start_x,
                                  left_thumb_metacarpal_start_y, left_thumb_metacarpal_start_z,
                                  left_thumb_metacarpal_end_x, left_thumb_metacarpal_end_y, left_thumb_metacarpal_end_z,
                                  ...
                                  left_thumb_proximal_start_y, left_thumb_proximal_start_z, left_thumb_proximal_end_x,
                                  left_thumb_proximal_end_y, left_thumb_proximal_end_z, left_thumb_proximal_direction_x,
                                  left_thumb_proximal_direction_y, left_thumb_proximal_direction_z,
                                  left_thumb_intermediate_start_x, left_thumb_intermediate_start_y,
                                  left_thumb_intermediate_start_z, left_thumb_intermediate_end_x,
                                  left_thumb_intermediate_end_y, left_thumb_intermediate_end_z,
                                  left_thumb_intermediate_direction_x, left_thumb_intermediate_direction_y,
                                  left_thumb_intermediate_direction_z, left_thumb_distal_start_x,
                                  left_thumb_distal_start_y, left_thumb_distal_start_z, left_thumb_distal_end_x,
                                  left_thumb_distal_end_y, left_thumb_distal_end_z, left_thumb_distal_direction_x,
                                  left_thumb_distal_direction_y, left_thumb_distal_direction_z, left_index_length,
                                  left_index_width, left_index_metacarpal_start_x, left_index_metacarpal_start_y,
                                  left_index_metacarpal_start_z, left_index_metacarpal_end_x,
                                  left_index_metacarpal_end_y, left_index_metacarpal_end_z,
                                  left_index_metacarpal_direction_x, left_index_metacarpal_direction_y,
                                  left_index_metacarpal_direction_z, left_index_proximal_start_x,
                                  left_index_proximal_start_y, left_index_proximal_start_z, left_index_proximal_end_x,
                                  left_index_proximal_end_y, left_index_proximal_end_z, left_index_proximal_direction_x,
                                  left_index_proximal_direction_y, left_index_proximal_direction_z,
                                  left_index_intermediate_start_x, left_index_intermediate_start_y,
                                  left_index_intermediate_start_z, left_index_intermediate_end_x,
                                  left_index_intermediate_end_y, left_index_intermediate_end_z,
                                  left_index_intermediate_direction_x, left_index_intermediate_direction_y,
                                  left_index_intermediate_direction_z, left_index_distal_start_x,
                                  left_index_distal_start_y, left_index_distal_start_z, left_index_distal_end_x,
                                  left_index_distal_end_y, left_index_distal_end_z, left_index_distal_direction_x,
                                  left_index_distal_direction_y, left_index_distal_direction_z, left_middle_length,
                                  left_middle_width, left_middle_metacarpal_start_x, left_middle_metacarpal_start_y,
                                  left_middle_metacarpal_start_z, left_middle_metacarpal_end_x,
                                  left_middle_metacarpal_end_y, left_middle_metacarpal_end_z,
                                  left_middle_metacarpal_direction_x, left_middle_metacarpal_direction_y,
                                  left_middle_metacarpal_direction_z, left_middle_proximal_start_x,
                                  left_middle_proximal_start_y, left_middle_proximal_start_z,
                                  left_middle_proximal_end_x, left_middle_proximal_end_y, left_middle_proximal_end_z,
                                  left_middle_proximal_direction_x, left_middle_proximal_direction_y,
                                  left_middle_proximal_direction_z, left_middle_intermediate_start_x,
                                  left_middle_intermediate_start_y, left_middle_intermediate_start_z,
                                  left_middle_intermediate_end_x, left_middle_intermediate_end_y,
                                  left_middle_intermediate_end_z, left_middle_intermediate_direction_x,
                                  left_middle_intermediate_direction_y, left_middle_intermediate_direction_z,
                                  left_middle_distal_start_x, left_middle_distal_start_y, left_middle_distal_start_z,
                                  left_middle_distal_end_x, left_middle_distal_end_y, left_middle_distal_end_z,
                                  left_middle_distal_direction_x, left_middle_distal_direction_y,
                                  left_middle_distal_direction_z, left_ring_length, left_ring_width,
                                  left_ring_metacarpal_start_x, left_ring_metacarpal_start_y,
                                  left_ring_metacarpal_start_z, left_ring_metacarpal_end_x, left_ring_metacarpal_end_y,
                                  left_ring_metacarpal_end_z, left_ring_metacarpal_direction_x,
                                  left_ring_metacarpal_direction_y, left_ring_metacarpal_direction_z,
                                  left_ring_proximal_start_x, left_ring_proximal_start_y, left_ring_proximal_start_z,
                                  left_ring_proximal_end_x, left_ring_proximal_end_y, left_ring_proximal_end_z,
                                  left_ring_proximal_direction_x, left_ring_proximal_direction_y,
                                  left_ring_proximal_direction_z, left_ring_intermediate_start_x,
                                  left_ring_intermediate_start_y, left_ring_intermediate_start_z,
                                  left_ring_intermediate_end_x, left_ring_intermediate_end_y,
                                  left_ring_intermediate_end_z, left_ring_intermediate_direction_x,
                                  left_ring_intermediate_direction_y, left_ring_intermediate_direction_z,
                                  left_ring_distal_start_x, left_ring_distal_start_y, left_ring_distal_start_z,
                                  left_ring_distal_end_x, left_ring_distal_end_y, left_ring_distal_end_z,
                                  left_ring_distal_direction_x, left_ring_distal_direction_y,
                                  left_ring_distal_direction_z, left_pinky_length, left_pinky_width,
                                  ...
                                  left_pinky_metacarpal_direction_x, left_pinky_metacarpal_direction_y,
                                  left_pinky_metacarpal_direction_z, left_pinky_proximal_start_x,
                                  left_pinky_proximal_start_y, left_pinky_proximal_start_z, left_pinky_proximal_end_x,
                                  left_pinky_proximal_end_y, left_pinky_proximal_end_z, left_pinky_proximal_direction_x,
                                  left_pinky_proximal_direction_y, left_pinky_proximal_direction_z,
                                  left_pinky_intermediate_start_x, left_pinky_intermediate_start_y,
                                  left_pinky_intermediate_start_z, left_pinky_intermediate_end_x,
                                  left_pinky_intermediate_end_y, left_pinky_intermediate_end_z,
                                  left_pinky_intermediate_direction_x, left_pinky_intermediate_direction_y,
                                  left_pinky_intermediate_direction_z, left_pinky_distal_start_x,
                                  left_pinky_distal_start_y, left_pinky_distal_start_z, left_pinky_distal_end_x,
                                  left_pinky_distal_end_y, left_pinky_distal_end_z, left_pinky_distal_direction_x,
                                  left_pinky_distal_direction_y, left_pinky_distal_direction_z, right_palm_position_x,
                                  right_palm_position_y, right_palm_position_z, right_palm_normal_x,
                                  right_palm_normal_y, right_palm_normal_z, right_hand_direction_x,
                                  right_hand_direction_y, right_hand_direction_z, right_palm_velocity_x,
                                  right_palm_velocity_y, right_palm_velocity_z, right_hand_pitch, right_hand_roll,
                                  right_hand_yaw, right_arm_direction_x, right_arm_direction_y, right_arm_direction_z,
                                  right_wrist_position_x, right_wrist_position_y, right_wrist_position_z,
                                  right_elbow_position_x, right_elbow_position_y, right_elbow_position_z,
                                  right_thumb_length, right_thumb_width, right_thumb_metacarpal_start_x,
                                  right_thumb_metacarpal_start_y, right_thumb_metacarpal_start_z,
                                  right_thumb_metacarpal_end_x, right_thumb_metacarpal_end_y,
                                  right_thumb_metacarpal_end_z, right_thumb_metacarpal_direction_x,
                                  right_thumb_metacarpal_direction_y, right_thumb_metacarpal_direction_z,
                                  right_thumb_proximal_start_x, right_thumb_proximal_start_y,
                                  right_thumb_proximal_start_z, right_thumb_proximal_end_x, right_thumb_proximal_end_y,
                                  right_thumb_proximal_end_z, right_thumb_proximal_direction_x,
                                  right_thumb_proximal_direction_y, right_thumb_proximal_direction_z,
                                  right_thumb_intermediate_start_x, right_thumb_intermediate_start_y,
                                  right_thumb_intermediate_start_z, right_thumb_intermediate_end_x,
                                  right_thumb_intermediate_end_y, right_thumb_intermediate_end_z,
                                  right_thumb_intermediate_direction_x, right_thumb_intermediate_direction_y,
                                  right_thumb_intermediate_direction_z, right_thumb_distal_start_x,
                                  right_thumb_distal_start_y, right_thumb_distal_start_z, right_thumb_distal_end_x,
                                  right_thumb_distal_end_y, right_thumb_distal_end_z, right_thumb_distal_direction_x,
                                  right_thumb_distal_direction_y, right_thumb_distal_direction_z, right_index_length,
                                  right_index_width, right_index_metacarpal_start_x, right_index_metacarpal_start_y,
                                  right_index_metacarpal_start_z, right_index_metacarpal_end_x,
                                  right_index_metacarpal_end_y, right_index_metacarpal_end_z,
                                  right_index_metacarpal_direction_x, right_index_metacarpal_direction_y,
                                  right_index_metacarpal_direction_z, right_index_proximal_start_x,
                                  right_index_proximal_start_y, right_index_proximal_start_z,
                                  right_index_proximal_end_x, right_index_proximal_end_y, right_index_proximal_end_z,
                                  right_index_proximal_direction_x, right_index_proximal_direction_y,
                                  right_index_proximal_direction_z, right_index_intermediate_start_x,
                                  right_index_intermediate_start_y, right_index_intermediate_start_z,
                                  right_index_intermediate_end_x, right_index_intermediate_end_y,
                                  right_index_intermediate_end_z, right_index_intermediate_direction_x,
                                  right_index_intermediate_direction_y, right_index_intermediate_direction_z,
                                  right_index_distal_start_x, right_index_distal_start_y, right_index_distal_start_z,
                                  right_index_distal_end_x, right_index_distal_end_y, right_index_distal_end_z,
                                  right_index_distal_direction_x, right_index_distal_direction_y,
                                  right_index_distal_direction_z, right_middle_length, right_middle_width,
                                  right_middle_metacarpal_start_x, right_middle_metacarpal_start_y,
                                  right_middle_metacarpal_start_z, right_middle_metacarpal_end_x,
                                  right_middle_metacarpal_end_y, right_middle_metacarpal_end_z,
                                  right_middle_metacarpal_direction_x, right_middle_metacarpal_direction_y,
                                  right_middle_metacarpal_direction_z, right_middle_proximal_start_x,
                                  right_middle_proximal_start_y, right_middle_proximal_start_z,
                                  right_middle_proximal_end_x, right_middle_proximal_end_y, right_middle_proximal_end_z,
                                  right_middle_proximal_direction_x, right_middle_proximal_direction_y,
                                  ...
                                  right_middle_intermediate_end_x, right_middle_intermediate_end_y,
                                  right_middle_intermediate_end_z, right_middle_intermediate_direction_x,
                                  right_middle_intermediate_direction_y, right_middle_intermediate_direction_z,
                                  right_middle_distal_start_x, right_middle_distal_start_y, right_middle_distal_start_z,
                                  right_middle_distal_end_x, right_middle_distal_end_y, right_middle_distal_end_z,
                                  right_middle_distal_direction_x, right_middle_distal_direction_y,
                                  right_middle_distal_direction_z, right_ring_length, right_ring_width,
                                  right_ring_metacarpal_start_x, right_ring_metacarpal_start_y,
                                  right_ring_metacarpal_start_z, right_ring_metacarpal_end_x,
                                  right_ring_metacarpal_end_y, right_ring_metacarpal_end_z,
                                  right_ring_metacarpal_direction_x, right_ring_metacarpal_direction_y,
                                  ...
                                  right_ring_proximal_end_y, right_ring_proximal_end_z, right_ring_proximal_direction_x,
                                  right_ring_proximal_direction_y, right_ring_proximal_direction_z,
                                  right_ring_intermediate_start_x, right_ring_intermediate_start_y,
                                  right_ring_intermediate_start_z, right_ring_intermediate_end_x,
                                  right_ring_intermediate_end_y, right_ring_intermediate_end_z,
                                  right_ring_intermediate_direction_x, right_ring_intermediate_direction_y,
                                  right_ring_intermediate_direction_z, right_ring_distal_start_x,
                                  right_ring_distal_start_y, right_ring_distal_start_z, right_ring_distal_end_x,
                                  right_ring_distal_end_y, right_ring_distal_end_z, right_ring_distal_direction_x,
                                  right_ring_distal_direction_y, right_ring_distal_direction_z, right_pinky_length,
                                  right_pinky_width, right_pinky_metacarpal_start_x, right_pinky_metacarpal_start_y,
                                  right_pinky_metacarpal_start_z, right_pinky_metacarpal_end_x,
                                  right_pinky_metacarpal_end_y, right_pinky_metacarpal_end_z,
                                  right_pinky_metacarpal_direction_x, right_pinky_metacarpal_direction_y,
                                  right_pinky_metacarpal_direction_z, right_pinky_proximal_start_x,
                                  right_pinky_proximal_start_y, right_pinky_proximal_start_z,
                                  right_pinky_proximal_end_x, right_pinky_proximal_end_y, right_pinky_proximal_end_z,
                                  right_pinky_proximal_direction_x, right_pinky_proximal_direction_y,
                                  right_pinky_proximal_direction_z, right_pinky_intermediate_start_x,
                                  right_pinky_intermediate_start_y, right_pinky_intermediate_start_z,
                                  right_pinky_intermediate_end_x, right_pinky_intermediate_end_y,
                                  right_pinky_intermediate_end_z, right_pinky_intermediate_direction_x,
                                  right_pinky_intermediate_direction_y, right_pinky_intermediate_direction_z,
                                  right_pinky_distal_start_x, right_pinky_distal_start_y, right_pinky_distal_start_z,
                                  right_pinky_distal_end_x, right_pinky_distal_end_y, right_pinky_distal_end_z,
                                  right_pinky_distal_direction_x, right_pinky_distal_direction_y,
                                  right_pinky_distal_direction_z]
            new_variables= []
            line = ""
            for attribute in recorded_variables:#recorded_variables:
                line = line + str(attribute) + ","
            #line = line + "/" + imageName
            #line = line #+ "," + move
            line=line + '\n'
            with open(filename2, "a") as dataset:
                dataset.write(line)
            print "recording"
